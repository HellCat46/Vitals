...
var Schemas = []string{
	...
	`CREATE TABLE IF NOT EXISTS requests (id INT PRIMARY KEY AUTO_INCREMENT, hospitalId INT REFERENCES hospital(userId), type tinyint, bloodgroup VARCHAR(10), unit int);`,
